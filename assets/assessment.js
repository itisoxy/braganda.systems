/* ═══════════════════════════════════════════════
   BRAGANDA SYSTEMS — Public GTM Systems Assessment
   Multi-step assessment wizard. Renders into #qz-app.
   Public-facing duplicate of questionnaire.js: identity/contact
   fields are asked as a "proper form" at the END of the flow
   instead of up front, to lower friction to start.
═══════════════════════════════════════════════ */
...
(function () {
  ...
  /* ── CONFIG ── */
  var SUBMIT_ENDPOINT = '/api/assessment';
  var BOOKING_URL = 'https://calendly.com/bragandasystemsenquiry';
  var STORAGE_KEY = 'bg_assessment_v1';
  ...
  var STEPS = [
    ...
    {
      id: 'commercial', group: 'Commercial Fit', title: 'A Few Final Questions',
      sub: 'These last few questions help us understand the likely scope.',
      fields: [
        {
        ...
        { id: 'call_objective', type: 'textarea', required: true, label: 'What would you most like us to help you figure out?' },
        { id: 'additional_information', type: 'textarea', required: false, label: 'Is there anything else we should know?' }
      ]
    },
    {
      id: 'details', group: 'Your Details', title: 'Your Details',
      headline: 'Where should we send your results?',
      sub: 'Last step — a few details so we can tailor what we send back and follow up on the areas with the biggest opportunity.',
      fields: [
        { id: 'company_name', type: 'text', label: 'Business name', required: true },
        ...
        { id: 'email', type: 'email', label: 'Work email', required: true },
        {
          ...
          options: O(['1–5', '6–20', '21–50', '51–200', '200+'])
        },
        {
  ...
  function renderStart(resumeData) {
    ...
    return (
      ...
      '<div class="qz-start">' +
      resumeHTML +
      '<div class="section-label orange">Free GTM Systems Assessment</div>' +
      '<h1>Let’s Find Where Revenue, Time and Opportunities Are Being Lost<span class="text-orange">.</span></h1>' +
      '<p class="qz-lead">Answer a few questions about how your business currently generates, manages and converts opportunities, and we’ll show you where better systems, automation and AI could create the biggest impact — then you can book a free session to walk through it.</p>' +
      ...
      '<p class="qz-start-note">No email required to start — we’ll only ask for your details at the end.</p>' +
      '</div></div>'
    );
  }
  ...
  function renderSubmitStage(errorMsg) {
    return (
      ...
      '<h2 class="qz-step-title">Ready to see your results?</h2>' +
      '<p class="qz-step-sub">We’ll use everything you’ve told us to identify where the opportunity is. You can still go back and adjust an answer first.</p>' +
  ...
  function renderComplete() {
    return (
      ...
      '<p class="qz-lead">We’ll use your answers to identify where the opportunity is, so your session can focus on practical, high-impact changes.</p>' +
